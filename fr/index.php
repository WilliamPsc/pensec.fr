...
<div class="container">
    ...
    <div class="container">
        ...
        <p class="justified-text">
            Depuis le 1<sup>er</sup> septembre 2025, je suis Maître de Conférences à l'Université de Montpellier, rattaché au Laboratoire d'Informatique, de Robotique et de Micro-électronique de Montpellier (LIRMM), au sein de l'équipe ADAC. J'enseigne à l'École Polytechnique Universitaire de Montpellier (Polytech Montpellier) dans le département Électronique et Informatique Industrielle (EII) pour la spécialité Micro-Électronique et Automatique (MEA) à des étudiants en cursus ingénieur.
        </p>
        ...
        <p class="justified-text">
            De 2021 à 2024, j’ai réalisé une thèse de doctorat en informatique à l’Université Bretagne Sud, au sein de l’équipe ARCAD du Laboratoire des Sciences et Techniques de l'Information, de la Communication et de la Connaissance (Lab-STICC), à Lorient. Mes travaux ont porté sur l’extension de la protection des processeurs contre les menaces physiques et logicielles, via la sécurisation d'un mécanisme DIFT (Dynamic Information Flow Tracking) face aux attaques par injections de fautes. J'ai soutenu cette thèse de Doctorat en décembre 2024, à Lorient.
        </p>
        <div class="row text-center mb-3">
            <div class="col-6 offset-3">
                <div class="row">
