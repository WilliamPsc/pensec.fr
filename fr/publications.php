            ...
            <li><strong>2023</strong>
                <ul>
                    <li>
                        ...
                        <p style="display: inline;font-size: medium;"> - Novembre 2023</p>
                    </li>
                </ul>
            </li>
        </ul>
    ...
    <ul>
        <li>
            ...
            <p style="margin-left: 20px;">
                ...
                <span style="margin-left: 30px;">Séminaire de l'équipe ADAC (LIRMM)</span><br>
            ...
            <p style="margin-left: 20px;">
                ...
                <br>
                <span style="margin-left: 30px; margin-top: -15px;">William Pensec</span><br>
                <span style="margin-left: 30px;">Séminaire de présentation de mes travaux de recherche</span><br>
                <span style="margin-left: 30px;">Montpellier, France</span>
            </p>
        </li>
        <li>
            ...
            <p style="margin-left: 20px;">
                ...
                <br>
                <span style="margin-left: 30px; margin-top: -15px;">William Pensec</span><br>
                <span style="margin-left: 30px;">Soutenance de thèse de doctorat</span><br>
