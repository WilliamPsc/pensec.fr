...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="navbar-brand" href="<?php echo $_SESSION['baseURL'] . $_SESSION['language'] . "/index.php"?>" style="color:white">Accueil</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="engagement">
                    ...
                    <a class="dropdown-item" href="<?php echo $_SESSION['baseURL'] . $_SESSION['language'] . "/conferences.php"?>"><i class="fas fa-book-reader"></i> Conférences</a> <!--à garder ou à changer ?-->
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="<?php echo $currPage?>" id="langages" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="flag-icon flag-icon-fr"> </span>  Français</a>
